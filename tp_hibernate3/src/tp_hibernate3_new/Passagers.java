...
/**
 * Passagers generated by hbm2java
 */
public class Passagers  implements java.io.Serializable {
    ...
    public Passagers(int numero) {
        this.numero = numero;
    }
    public Passagers(int numero, Pays pays, String nom, String prenom, String adresse, String ville, String tel, String pieceIdentite, Set reservationses) {
       this.numero = numero;
       this.pays = pays;
       this.nom = nom;
       this.prenom = prenom;
