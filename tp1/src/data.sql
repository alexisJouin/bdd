#Structure de la BDD du TP1 JDBC
...
INSERT INTO groupes (idgroupe, nomgroupe, commentairegroupe) 
    VALUES 
        (1,'groupe 1', NULL),
        (2,'groupe 2', NULL);

INSERT INTO personnes (idpersonne, nompersonne, prenompersonne, datenaisspersonne, coeffpersonne)
    VALUES
...
INSERT INTO grppers (idgrppers, idgroupe, idpersonne)
    VALUES
        (1,1,1),
        (2,2,2),
        (3,2,3),
